...
const trending = [
  { id: "1", title: "Salami and cheese pizza", desc: "Quick overview of the ingredients...", image: "https://media.istockphoto.com/id/184946701/vi/anh/pizza.jpg?s=612x612&w=0&k=20&c=D6eJLNuSWoDoCmWyY42axAKmJykI5zLJNsItLy5KB84=", time: "30min", likes: 5 }
];
const yourRecipes = [
  { id: "2", title: "Chicken Burger", desc: "Delicious homemade burger", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSyDcH_MxdsTsK6KMVon-Ybfa2WiT-R70ZjWw&s", time: "15min", likes: 5 },
  { id: "3", title: "Tiramisu", desc: "Classic Italian dessert", image: "https://daotaobeptruong.vn/wp-content/uploads/2020/11/banh-tiramisu.jpg", time: "15min", likes: 5 }
];
const recentlyAdded = [
  { id: "4", title: "Lemonade", desc: "Acidic and refreshing", image: "https://herbsandflour.com/wp-content/uploads/2020/05/Homemade-Lemonade-Recipe.jpg", time: "30min", likes: 4 },
  { id: "5", title: "Taco", desc: "Spicy Mexican taco", image: "https://mojo.generalmills.com/api/public/content/GmHhoT5mr0Sue2oMxdyEig_webp_base.webp?v=c67813e4&t=191ddcab8d1c415fa10fa00a14351227", time: "25min", likes: 3 }
];
  ...
  return (
    <SafeAreaView style={s.safe}>
      <ScrollView showsVerticalScrollIndicator={false} style={s.container}>
        ...
        <View style={s.header}>
          <View>
            <Text style={s.title}>Hi! Dianne</Text>
            <Text style={s.subtitle}>What are you cooking today</Text>
          </View>
          <View style={s.iconRow}>
            <TouchableOpacity style={s.iconBtn}><Ionicons name="notifications-outline" size={20} color="#f77" /></TouchableOpacity>
            <TouchableOpacity style={s.iconBtn}><Ionicons name="cart-outline" size={20} color="#f77" /></TouchableOpacity>
          </View>
        </View>
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <TouchableOpacity style={s.catBtn} onPress={() => navigation.navigate("Category", { category: item })}>
...
const s = StyleSheet.create({
  ...
  catBtn:{paddingHorizontal:14,paddingVertical:6,borderRadius:20,marginRight:10,backgroundColor:"#fff",borderWidth:1,borderColor:"#f77"},
  catText:{fontSize:14,color:"#f77"},
  sectionTitle:{fontSize:18,fontWeight:"600",marginVertical:12,color:"#333"},
  trendingCard:{backgroundColor:"#fff",borderRadius:12,marginRight:16,width:width*0.7,overflow:"hidden",elevation:2},
  trendingImage:{width:"100%",height:150},heartButton:{position:"absolute",top:10,right:10,backgroundColor:"#fff",borderRadius:20,padding:6},
  trendingInfo:{padding:10},trendingTitle:{fontSize:15,fontWeight:"600"},trendingDesc:{fontSize:12,color:"#777",marginBottom:6},
  row:{flexDirection:"row",alignItems:"center"},infoText:{fontSize:12,color:"#777",marginLeft:4},
  sectionBox:{backgroundColor:"#f77",borderRadius:16,paddingVertical:12,paddingHorizontal:8,marginVertical:12},
  ...
  smallImage:{width:"100%",height:100},heartSmall:{position:"absolute",top:8,right:8,backgroundColor:"#fff",borderRadius:20,padding:4},
  smallTitle:{fontSize:14,fontWeight:"600"},smallDesc:{fontSize:11,color:"#777",marginBottom:4},
