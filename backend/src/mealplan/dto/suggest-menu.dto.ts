...
export class SuggestMenuDto {
  @ApiProperty({
    description: "Ngày áp dụng (ISO 8601)",
    example: "2024-01-15",
  })
  @IsDateString()
  ...
  // tuỳ chọn
  @ApiProperty({
    description: "Bao gồm món khai vị",
    example: false,
    required: false,
    default: false,
  })
  ...
  @ApiProperty({
    description: "Bao gồm món tráng miệng",
    example: false,
    required: false,
    default: false,
  })
  ...
  @ApiProperty({
    description: "Ưu tiên vùng miền",
    enum: ["Northern", "Central", "Southern"],
    example: "Northern",
    required: false,
  })
  @IsOptional()
  ...
  @ApiProperty({
    description: "Nguyên liệu loại trừ (phân tách bằng dấu phẩy)",
    example: "peanuts,shrimp",
    required: false,
  })
  @IsOptional()
  @IsString()
